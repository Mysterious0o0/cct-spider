...
import (
	...
	"cct-spider-s/internal/govserver/api/v1/anhui"
	"cct-spider-s/internal/govserver/api/v1/beijing"
	"cct-spider-s/internal/govserver/api/v1/chongqing"
	"cct-spider-s/internal/govserver/api/v1/guangzhou"
	"cct-spider-s/internal/govserver/api/v1/shanghai"
	"cct-spider-s/internal/govserver/api/v1/tianjin"
