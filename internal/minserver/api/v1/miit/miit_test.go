...
func TestXpath(t *testing.T) {
	...
	//GetFirstUrl(url)
	pageUrl := "https://www.miit.gov.cn/search-front-server/api/search/info?websiteid=110000000000000&scope=basic&q=&pg=10&cateid=57&pos=title_text%2Cinfocontent%2Ctitlepy&selectFields=title,url,&group=distinct&level=6&sortFields=%5B%7B%22name%22%3A%22deploytime%22%2C%22type%22%3A%22desc%22%7D%5D&p=0"
	...
	//GetHtmlInfo(infoUrl, "https://www.miit.gov.cn")
